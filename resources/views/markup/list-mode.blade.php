                      ...
                      <div class="game__edit-popup game-edit">
                        ...
                        <div class="game-edit__item game-edit__radio">
                          <div class="game-edit__radio-item">
                            <input class="game-edit__radio-input visually-hidden" type="radio" id="digital-type"
                              name="exist-type" value="digital" checked>
                            <label class="game-edit__radio-label" for="digital-type">Digital</label>
                          </div>
                          <div class="game-edit__radio-item">
                            <input class="game-edit__radio-input visually-hidden" type="radio" id="physic-type"
                              name="exist-type" value="physic">
    ...
    <div class="modal">
      <div class="modal__container">
        ...
        <div class="modal-radio">
          ...
          <div class="modal-radio__list">
            <label class="modal-radio__item">
              <input type="radio" class="modal-radio__radio visually-hidden" name="select-platform"
                value="Nintendo Switch" checked>
        ...
        <div class="modal-radio">
          ...
          <div class="modal-radio__list">
            <label class="modal-radio__item">
              <input type="radio" class="modal-radio__radio visually-hidden" name="select-status"
                value="Nintendo Switch" checked>
              <span class="modal-radio__text">
                Done
              </span>
